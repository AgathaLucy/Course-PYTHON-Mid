# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 18:57:14 2020

@author: 9
"""

'''
Oto otrzymałeś specjalne zadanie. Trzeba napisać klasę, która będzie 
odpowiedzialna za:
...
Twoja nowa klasa ma być wykorzystywana jako Context Manager. Aktualnie istnieje 
plan pobrania pliku zip i rozpakowywania jego zawartości, ale to ma się już 
zadziać w Context Managerze poza klasą. Jeśli wiesz jak to zrobić, to do dzieła, 
a jak chcesz dokładniejszych instrukcji to patrz:
...
utwórz instancje klasy FileFromWeb korzystając z argumentów (gdyby adres web 
nie odpowiadał, to zmień go na dowolny inny plik zip):
...
w bloku with utwórz następne wyrażenie with - utwórz instancję klasy zipfile.ZipFile - 
przekaż jako argumenty:
...
pobierz nazwę pierwszego pliku znajdującego się w archiwum zip korzystając z 
metody z.namelist()[0]. Zapisz wynik w zmiennej a_file
