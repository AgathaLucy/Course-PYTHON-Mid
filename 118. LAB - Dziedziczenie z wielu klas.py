# -*- coding: utf-8 -*-
"""
Created on Thu May 14 00:50:43 2020
...
W celu organizowania promocji na wypieki należy zdefiniować klasę dziedziczącą 
zarówno z Cake jak i z Promo

Zdefiniuj klasę PromoCake dziedziczącą z Cake i Promo

W metodzie  __init__ przyjmij argumenty cake i promo, a następnie wywołaj 
__init__ z klas rodzicielskich

Utwórz obiekt promo_cake z klasy PromoCake

Wywołaj dla tego obiektu metodę show_info. Spróbuj przed uruchomieniem odgadnąć 
wynik
