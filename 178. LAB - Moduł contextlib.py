# -*- coding: utf-8 -*-
"""
Created on Thu Jul 23 15:55:05 2020
...
w metodzie close zakomentuj wyrażenie if. Niech instrukcja usuwająca plik 
wykonuje się bezwarunkowo

uruchom kod - powinien działać poprawnie

odkomentuj ostatnią linijkę usuwającą plik. Uruchom ponownie skrypt, który tym 
razem powinien się kończyć błędem.

Naprawmy to:

Dodany w poprzednich krokach blok with umieść w kolejnym bloku with, który 
"ukryje" wyjątek FileNotFoundError
'''
